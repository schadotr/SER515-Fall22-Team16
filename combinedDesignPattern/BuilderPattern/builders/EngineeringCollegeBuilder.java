...
public class EngineeringCollegeBuilder implements CourseBuilder {
	...
	public void setGradeWeightage(Grade gradeWeight){
		...
		if(this.gradeWeightage.assignment != null) {
			setAssignmentsWeightage((int)this.gradeWeightage.assignment);
		}
		if(this.gradeWeightage.quiz != null) {
			setQuizWeightage((int)this.gradeWeightage.quiz);
		}
		if(this.gradeWeightage.midTerm != null) {
			setMidTermWeightage((int)this.gradeWeightage.midTerm);
		}
		if(this.gradeWeightage.presentation != null) {
			setPresentationWeightage((int)this.gradeWeightage.presentation);
		}
		if(this.gradeWeightage.finalExam != null) {
			setFinalExamWeightage((int)this.gradeWeightage.finalExam);
		}
	}
	...
	public SCAI getCourse(){
		return new SCAI(collegeType, mandatoryFields, instructor, website, officeHours, slackChannel, ta, ga, examDate, gradeWeightage, absencePolicy, booksAndReferences, schedule, rules, academicIntegrity);
	}
}
